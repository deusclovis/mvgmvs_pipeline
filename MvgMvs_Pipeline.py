...
# OPENMVG_BIN = "openMVG_Build/Linux-x86_64-RELEASE"
OPENMVG_BIN = "openMVG_Build/Linux-x86_64-RELEASE"
OPENMVS_BIN = "openMVS_dev_build/bin"

# Indicate the openMVG camera sensor width directory
# CAMERA_SENSOR_WIDTH_DIRECTORY = "/home/ubuntu/openMVG/src/openMVG/exif/sensor_width_database"
    ...
    def __init__(self):
        self.steps_data=[
            ...
            [   "Compute features",
                ...
                ["-i", "%matches_dir%/sfm_data.json", "-o", "%matches_dir%", "-m", "SIFT", "-n", "2"] ],
            [   "Compute matches",
